(function () {
  ...
  var I18N = {
    "zh-TW": {
      ...
      footerCta: "以 JSON API 驅動",
      heroSubtitle: "純 Ruby 星曆計算的免費占星 API — 本命盤、合盤、行運、推運、太陽回歸、組合盤，支援繁中／English／日本語／한국어。",
      featPlanets: "14 天體",
      featCharts: "6 種盤",
      featLangs: "4 語 API",
      featFree: "免費開放",
    ...
    en: {
      ...
      brandSub: "Astrology",
      navDocs: "API Docs",
      navSignup: "Get API key",
      footerTag: "Pure-Ruby ephemeris",
      footerCta: "Powered by a JSON API",
      heroSubtitle: "Free astrology API powered by a pure-Ruby ephemeris — natal, synastry, transits, progressions, solar return, composite; in 繁中 / English / 日本語 / 한국어.",
      featPlanets: "14 bodies",
      featCharts: "6 chart types",
      featLangs: "4-language API",
      featFree: "Free & open",
      langAria: "Language",
      tabsAria: "Chart type",
    ...
    ja: {
      ...
      footerCta: "JSON API 駆動",
      heroSubtitle: "純Ruby天文暦による無料占星術API — 出生図・相性・トランジット・進行・ソーラーリターン・コンポジット、繁体字中国語／English／日本語／한국어対応。",
      featPlanets: "14 天体",
      featCharts: "6 種のチャート",
      featLangs: "4言語API",
      featFree: "無料公開",
    ...
    ko: {
      ...
      footerCta: "JSON API 기반",
      heroSubtitle: "순수 Ruby 천체력 기반 무료 점성술 API — 출생 차트, 궁합, 트랜짓, 프로그레션, 솔라 리턴, 컴포지트; 번체 중국어／English／日本語／한국어 지원.",
      featPlanets: "14 천체",
      featCharts: "6가지 차트",
      featLangs: "4개 언어 API",
      featFree: "무료 공개",
